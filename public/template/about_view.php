		...
		<div class="row align-items-center justify-content-between">
			...
			<div class="col-lg-5 col-md-12 about-right">
				...
				<div class="mb-50 wow fadeIn" data-wow-duration=".8s">
					<p>
						Свою трудовую деятельность я начал в далеком 1996 году. Еще будучи студентом, меня пригласили поработать преподавателем программирования. С тех пор прошло много лет, но и по сей день моя деятельность связана с информационными технологиями.
					</p>
...
<section class="job-area offwhite section-gap-top section-gap-bottom-90">
	<div class="container">
		<div class="row d-flex">
			<div class="col-lg-12">
				<div class="section-title">
					<h2>Мой трудовой путь</h2>
					<p>Здесь перечислены основные вехи моей карьеры (валидный опыт).</p>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-lg-6">
				<div class="single-job">
					<div class="top-sec d-flex justify-content-between">
						<div class="top-left">
							<h4>Моя нынешняя должность</h4>
							<p>Компания, г. Ростов-на-Дону</p>
						</div>
						<div class="top-right">
					...
					<div class="bottom-sec wow fadeIn" data-wow-duration="2s">
						Здесь я перечисляю основные должностные обязанности, которые я должен выполнять, занимая эту должность.
					</div>
				</div>
			</div>
			...
			<div class="col-lg-6">
				<div class="single-job">
					<div class="top-sec d-flex justify-content-between">
						<div class="top-left">
							<h4>Моя предыдущая должность</h4>
							<p>Компания, г.Ростов-на-Дону</p>
						</div>
						<div class="top-right">
							<a href="#" class="primary-btn" data-text="Jul '15 to Present">
					...
					<div class="bottom-sec wow fadeIn" data-wow-duration="2s" data-wow-delay="0.2s">
						Здесь нужно перечислить обязанности, которые необходимо было выполнять в связи с знимаемой должностью.
					</div>
				</div>
			</div>
